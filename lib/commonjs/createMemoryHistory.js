...
function createMemoryHistory() {
  ...
  const currentId = (_window$history = window.history) === null || _window$history === void 0 ? void 0 : (_window$history$state = _window$history.state) === null || _window$history$state === void 0 ? void 0 : _window$history$state.id;
  ...
  const getStatelessItems = () => items.slice(0, index + 1).map(item => ({
    path: item.path,
    id: item.id
  }));
  const interrupt = () => {
  ...
  const history = {
    get index() {
      ...
      const id = (_window$history$state2 = window.history.state) === null || _window$history$state2 === void 0 ? void 0 : _window$history$state2.id;
      if (id) {
    ...
    replace(_ref3) {
      ...
      interrupt();
      const id = ((_window$history$state3 = window.history.state) === null || _window$history$state3 === void 0 ? void 0 : _window$history$state3.id) ?? (0, _nonSecure.nanoid)();
